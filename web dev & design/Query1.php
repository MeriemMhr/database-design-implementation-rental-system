...
SELECT
    ...
    AVG(RC.rating) AS average_customer_rating
...
LEFT JOIN Review_Comments RC ON LA.agent_id = RC.agent_id
...
echo "<b>Objective of this page: Query 1:In the context of rentals.com, the goal of this query is to 
retrieve essential information about listing agents, including their rental history, active listings, completed deals, and customer reviews. 
By collecting and analyzing these metrics, the query aims to provide insights into the overall performance of each agent. 
This information is crucial for evaluating agents' effectiveness in terms of their rental activities and customer feedback. 
It assists in making informed decisions about agent assignments and improving 
...
if ($res) {
    while ($newArray = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
        ...
        echo "Completed Deals: " . $newArray['completed_deals'] . "<br>";
        echo "Average Customer Rating: " . $newArray['average_customer_rating'] . "<br><br><br>";
    }
} else {
